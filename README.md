...
Для операции процент вводится число и вводится какой процент вычислить от введенного раннее числа. Для квадратного корня вводится число, выбирается операция квадратного корня, нажимается кнопка "равно". Остальные операции стандартные.
